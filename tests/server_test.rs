...
#[test]
fn test_page1() {
    test_resource("page1", StatusCode::Ok, "page1");
}

#[test]
fn test_page2() {
    test_resource("page2", StatusCode::Ok, "page2");
}

#[test]
fn test_page3() {
    test_resource("page3", StatusCode::Ok, "page3");
}

#[test]
fn test_page_not_found() {
    let expected = format!("{}", StatusCode::NotFound.as_u16());
    test_resource("notAValidPage", StatusCode::NotFound, expected.as_str());
}
